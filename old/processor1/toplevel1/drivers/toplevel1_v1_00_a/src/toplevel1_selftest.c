/*****************************************************************************
* Filename:          C:\Users\chribru\Desktop\GitHub\tdt4255\processor1\toplevel1/drivers/toplevel1_v1_00_a/src/toplevel1_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the toplevel1 driver
...
XStatus TOPLEVEL1_SelfTest(void * baseaddr_p)
{
  ...
  TOPLEVEL1_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TOPLEVEL1_mReadSlaveReg0(baseaddr, 0);
  ...
  TOPLEVEL1_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TOPLEVEL1_mReadSlaveReg1(baseaddr, 0);
  ...
  TOPLEVEL1_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = TOPLEVEL1_mReadSlaveReg2(baseaddr, 0);
  ...
  TOPLEVEL1_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = TOPLEVEL1_mReadSlaveReg3(baseaddr, 0);
  ...
  TOPLEVEL1_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = TOPLEVEL1_mReadSlaveReg4(baseaddr, 0);
