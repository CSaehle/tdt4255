...
-- Date:              Wed Jul  6 09:06:12 2011 (by Create and Import Peripheral Wizard)
...
begin
  ...
  TDT4255_TOPLEVEL : toplevel port map (clk => Bus2IP_Clk,
                                        reset => Bus2IP_Reset,
                                        command => slv_reg0,
                                        bus_address_in => slv_reg1,
                                        bus_data_in => slv_reg2,
                                        status => slv_reg3,
